...
- Disable MAC address lookup using https://api.macvendors.com. This will keep the scan local and not send requests out to the internet for more device information. Slightly increasing scan speed but also makes it harder to identify what the devices on your network are.
